...
class StudentService:
    ...
    Pure business logic: depends only on the StudentRepository port — swap the
    adapter (Postgres, in-memory fake) and this class is untouched. Caching is
    intentionally *not* a concern here; it lives in CachedStudentService, which
    wraps this class. That keeps these unit tests free of any cache plumbing.
    """
